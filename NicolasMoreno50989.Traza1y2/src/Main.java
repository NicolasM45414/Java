...
// Inicializar repositorios
        ...
        SucursalArticulo aprobacion2 = SucursalArticulo.builder().
                ...
                fechaAlta(LocalDate.now()).
                build();
        SucursalArticulo aprobacion3 = SucursalArticulo.builder().
                sucursal(sucursal1).
                articulo(aceite).
                precio(800).
                stock(0).
        ...
        sucursalArticuloRepository.save(aprobacion3);
        // Mostrar todas las aprobaciones
        System.out.println("Todos los resultados de las aprobaciones:");
